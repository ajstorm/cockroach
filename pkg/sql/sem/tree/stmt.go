...
// StatementReturnType implements the Statement interface.
func (*ShowAutoMultiRegionRecommendations) StatementReturnType() StatementReturnType { return Rows }

// StatementType implements the Statement interface.
func (*ShowAutoMultiRegionRecommendations) StatementType() StatementType { return TypeDML }

// StatementTag returns a short string identifying the type of statement.
func (*ShowAutoMultiRegionRecommendations) StatementTag() string { return "SHOW" }
...
func (n *ShowAutoMultiRegionRecommendations) String() string { return AsString(n) }
