...
const (
	...
	TypeDescriptor_TABLE_IMPLICIT_RECORD_TYPE TypeDescriptor_Kind = 3
)
...
type TableDescriptor struct {
	...
	DrainingNames []NameInfo `protobuf:"bytes,21,rep,name=draining_names,json=drainingNames" json:"draining_names"` // Deprecated: Do not use.
	...
	// Is auto multi-region enabled
	AutoMultiRegionEnabled bool `protobuf:"varint,47,opt,name=auto_multi_region_enabled,json=autoMultiRegionEnabled" json:"auto_multi_region_enabled"`
	// FIXME: This should be removed and put into a struct with the field above
	// Sampling to use for auto multi-region
	AutoMultiRegionSampling float32 `protobuf:"fixed32,48,opt,name=auto_multi_region_sampling,json=autoMultiRegionSampling" json:"auto_multi_region_sampling"`
}
...
func (m *TableDescriptor) GetAutoMultiRegionEnabled() bool {
	if m != nil {
		return m.AutoMultiRegionEnabled
	}
	return false
}

func (m *TableDescriptor) GetAutoMultiRegionSampling() float32 {
	if m != nil {
		return m.AutoMultiRegionSampling
	}
	return 0
}
...
type DatabaseDescriptor struct {
	...
	Version          DescriptorVersion `protobuf:"varint,5,opt,name=version,casttype=DescriptorVersion" json:"version"`
	// TODO(postamar): remove draining_names field in 22.2
	DrainingNames []NameInfo           `protobuf:"bytes,6,rep,name=draining_names,json=drainingNames" json:"draining_names"` // Deprecated: Do not use.
	...
	// Is auto multi-region enabled
	AutoMultiRegionEnabled bool `protobuf:"varint,12,opt,name=auto_multi_region_enabled,json=autoMultiRegionEnabled" json:"auto_multi_region_enabled"`
	// FIXME: This should be removed and put into a struct with the field above
	// Sampling to use for auto multi-region
	AutoMultiRegionSampling float32 `protobuf:"fixed32,48,opt,name=auto_multi_region_sampling,json=autoMultiRegionSampling" json:"auto_multi_region_sampling"`
}
...
func (m *DatabaseDescriptor) GetAutoMultiRegionEnabled() bool {
	if m != nil {
		return m.AutoMultiRegionEnabled
	}
	return false
...
func (m *DatabaseDescriptor) GetAutoMultiRegionSampling() float32 {
	if m != nil {
		return m.AutoMultiRegionSampling
	}
	return 0
...
type DatabaseDescriptor_SchemaInfo struct {
	...
	//
	// TODO(postamar): remove dropped field in 22.2
	Dropped bool `protobuf:"varint,2,opt,name=dropped" json:"dropped"` // Deprecated: Do not use.
}
...
type TypeDescriptor struct {
	...
	// TODO(postamar): remove draining_names field in 22.2
	DrainingNames []NameInfo `protobuf:"bytes,11,rep,name=draining_names,json=drainingNames" json:"draining_names"` // Deprecated: Do not use.
...
type SchemaDescriptor struct {
	...
	// TODO(postamar): remove draining_names field in 22.2
	DrainingNames []NameInfo `protobuf:"bytes,7,rep,name=draining_names,json=drainingNames" json:"draining_names"` // Deprecated: Do not use.
...
var fileDescriptor_12dcc21c3bcc9571 = []byte{
	...
	,
}
...
func (this *TableDescriptor) Equal(that interface{}) bool {
	...
	if this.AutoMultiRegionEnabled != that1.AutoMultiRegionEnabled {
		return false
	}
	if this.AutoMultiRegionSampling != that1.AutoMultiRegionSampling {
		return false
	}
	return true
}
...
func (m *TableDescriptor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	i -= 4
	encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.AutoMultiRegionSampling))))
	i--
	dAtA[i] = 0x3
	i--
	dAtA[i] = 0x85
	i--
	if m.AutoMultiRegionEnabled {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 47:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoMultiRegionEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoMultiRegionEnabled = bool(v != 0)
		case 48:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoMultiRegionSampling", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 4
			m.AutoMultiRegionSampling = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(dAtA[iNdEx:])
			if err != nil {
